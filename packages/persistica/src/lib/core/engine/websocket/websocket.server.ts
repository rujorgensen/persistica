...
import { TodoPersisticaNetwork } from './server/network.server.js';
...
export class PersisticaWebsocketServer {
    ...
    private readonly networkWebsocketServer: TodoPersisticaNetwork;
    ...
    constructor(
        ...
        this.networkWebsocketServer = new TodoPersisticaNetwork(
            'ni-ZFQ9QzK9oSHpCGRU70uF8', // !TODODOOD
            this.rpcServer,
        );
